...
%dane symboliczne
fprintf('\n#### wczytywanie danych do cwiczenia 2 ####\n')
...
DHsym=[ theta1             sym('0')        a1          sym('pi/2');
        theta2             sym('0')        a2          sym('pi/2');
        sym('0')           d3              sym('0')    sym('(3/2)*pi');
        theta4             sym('0')        a4          sym('0')];

%macierz z danymi robota, wym w [mm]
danerobota=[  a1    a2      d3      a4;
%             33.2    97.9    21.6    146.8];
       50    100    50    150];
...
%Eulsym symboliczne wyznaczanie katow Eulera...symboliczne
 ...
 %Eulnum wyznaczanie katow eulera numerycznie
            ...
            zadaneqi0=[0 0 0 0 0 0 ];
            zadaneqi1=[30 30 -30 -30 30 0 ];
            zadaneqi2=[0 90 0 0 0 0 ];
            
fprintf('#### zakonczono wczytywanie danych cwiczenia 2 ####\n\n')
